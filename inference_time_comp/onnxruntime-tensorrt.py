...
def classify_image_onnx_cpu(image_path):
    ...
    print(f"Avg Inference Time (TensorRT Provider): {(avg_time*1000):.6f} ms")

classify_image_onnx_cpu("/home/ertugrul/models_ws/src/comp_models/images/Cat_November_2010-1a.jpg")
